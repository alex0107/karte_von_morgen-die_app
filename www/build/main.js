...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leaflet__ = __webpack_require__(209);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__entry_entry__ = __webpack_require__(62);
...
var EntrycardPage = /** @class */ (function () {
    ...
    EntrycardPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */]])
    ], EntrycardPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_search_search__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_terms_terms__ = __webpack_require__(228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_entry_entry__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_file__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_splash_screen__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_storage__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_search_search__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_intro_intro__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_storage__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_papaparse__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_papaparse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_papaparse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_file__ = __webpack_require__(59);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp.prototype.setoldloc = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
    ...
    MyApp.prototype.searchtag = function (tag) {
        this.searchTerm = "#" + tag;
        ...
        this.loader.present().then(function () {
            ...
            if (_this.searchTerm !== undefined) {
                ...
                _this.file.readAsText(path, 'data.csv')
                    ...
                    _this.parsedData = __WEBPACK_IMPORTED_MODULE_10_papaparse__["parse"](fileStr).data;
    ...
    MyApp.prototype.distance = function (lat1, lon1, lat2, lon2, unit) {
    ...
    MyApp.prototype.entryfromhome = function () {
        return __awaiter(this, void 0, void 0, function () {
            var entry;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.get('entryhome')];
                    case 1:
                        entry = _a.sent();
                        if (entry !== null) {
    ...
    MyApp.prototype.showitem = function (item) {
        this.clickeditem = item;
        this.tags = item[14].split(',');
        this.tags.splice(this.tags.length - 1, 1);
        this.storage.set('entrysidebar', item);
    };
    MyApp.prototype.openSearchPage = function () {
        console.log('8218 OpenSearchPage');
        this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_7__pages_search_search__["a" /* SearchPage */]);
    };
    ...
    MyApp.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            setInterval(function () { return _this.entryfromhome(); }, 250);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leaflet__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leaflet___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_leaflet__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_papaparse__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_splash_screen__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__search_search__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__entry_entry__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(app, navCtrl, file, transfer, platform, storage, splashScreen, diagnostic, locationAccuracy, network, elementRef, backgroundGeolocation, loading, alertCtrl, nativeGeocoder, menuCtrl) {
        this.app = app;
        this.navCtrl = navCtrl;
        this.file = file;
    ...
    HomePage.prototype.ionViewDidEnter = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (_this.network.type === 'none') {
                ...
                setInterval(function () { return _this.checkstorage(); }, 250);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.storage.get('entrysidebar')];
                    case 1:
                        _a.entry = _b.sent();
                        if (this.entry !== null) {
    ...
    HomePage.prototype.setentrymarker = function () {
        this.map.setView([parseFloat(this.entry[6]), parseFloat(this.entry[7]) + 0.0035], 15);
        __WEBPACK_IMPORTED_MODULE_2_leaflet___default.a.popup().setLatLng([parseFloat(this.entry[6]) + 0.001, this.entry[7]]).setContent(this.entry[4]).openOn(this.map);
    };
    ...
    HomePage.prototype.addmymarkers = function (data, pic) {
        ...
        if (data[16] >= 0) {
            ...
            marker.on("click", function (event) {
                _this.storage.set('entrysidebar', data);
                _this.storage.set('entryhome', data);
                _this.menuCtrl.open("left");
            });
            var div_popup = __WEBPACK_IMPORTED_MODULE_2_leaflet___default.a.DomUtil.create('div', 'abcpopup');
            var self_1 = this;
            div_popup.innerHTML = "<b>" + data[4] + "</b><br>" + data[5] + "<br><b>" + data[8] + "<br>" + data[9] + " " + data[10] + '<a class="more" style="position: absolute; right: 1em;">mehr...</a>';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_papaparse__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_file__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__entry_entry__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__entrycard_entrycard__ = __webpack_require__(221);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
