...
var SearchlocalPage = /** @class */ (function () {
    function SearchlocalPage(navCtrl, file, platform, storage, loading, navParams, app) {
    ...
    SearchlocalPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */]])
    ], SearchlocalPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_launch_navigator__ = __webpack_require__(94);
...
var EntrylocalPage = /** @class */ (function () {
    function EntrylocalPage(navCtrl, navParams, launchnavigator, storage, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    EntrylocalPage.prototype.ionViewWillEnter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var storeditem;
            return __generator(this, function (_a) {
                console.log('8218 Will Enter');
                storeditem = this.storage.get('entrytab');
                if (storeditem !== null) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__entry_entry__ = __webpack_require__(97);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EntrycardPage = /** @class */ (function () {
    ...
    EntrycardPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */]])
    ], EntrycardPage);
...
var TermsPage = /** @class */ (function () {
    ...
    TermsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */]])
    ], TermsPage);
    return TermsPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_home_home__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_entry_entry__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_searchlocal_searchlocal__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_entrylocal_entrylocal__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_splash_screen__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__ionic_native_launch_navigator__ = __webpack_require__(94);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_file__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__home_home__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__entry_entry__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__searchlocal_searchlocal__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__entrylocal_entrylocal__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_splash_screen__ = __webpack_require__(96);
...
var HomePage = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(this.entry !== null)) return [3 /*break*/, 6];
                        this.popup = 1;
                        if (!(this.entry[13] == 'Initiative')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.addmymarkers(this.entry, 1, 0)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 3:
                        if (!(this.entry[13] == 'Unternehmen')) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.addmymarkers(this.entry, 0, 0)];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 5:
    ...
    HomePage.prototype.addmymarkers = function (data, pic, openpopup) {
        if (data[16] >= 0) {
            ...
            var div_popup = __WEBPACK_IMPORTED_MODULE_2_leaflet___default.a.DomUtil.create('div', 'abcpopup');
            var self_1 = this;
            div_popup.innerHTML = "<b>" + data[4] + '</b><button color="light" class="more" style="height: 36px; margin-right: 8px; margin-left: 8px; padding-top: 12px; padding-bottom: 12px; background-color: rgba(244,244,244,0.8);">mehr...</button>'; //<button style="height: 36px; width: 36px;  padding-bottom: 12px; padding-top: 12px; background-color: rgba(244,244,244,0.8);" class="close">X</button>';
            __WEBPACK_IMPORTED_MODULE_4_jquery__('button.more', div_popup).on('click', function () {
                self_1.gotoEntry(data);
            });
            /*
            $('button.close', div_popup).on('click', function() {
                self.map.closePopup();
            });
             */
    ...
    HomePage.prototype.gotoEntry = function (event) {
        console.log('8218 GotoEntryPage');
        this.popup = 1;
        this.storage.set('entrytab', event);
        this.navCtrl.parent.select(1);
    };
    ...
    HomePage.prototype.loadmap = function (zoommax) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('8218 Function Loadmap...');
                        return [4 /*yield*/, this.diagnostic.isLocationEnabled()
                                ...
                                _this.loader.present().then(function () {
                                    ...
                                    console.log('8218 Popup: ' + _this.popup + ' Firsttime: ' + _this.firsttime);
                                    if (state === true) {
                                        if (_this.popup == 0) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        if (!(((_a) && this.deleted === 0) || this.oldlat - 0.1 >= this.statlat || this.oldlat + 0.1 <= this.statlat || this.oldlong - 0.1 >= this.statlong || this.oldlong + 0.1 <= this.statlong)) return [3 /*break*/, 5];
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_8__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_splash_screen__["a" /* SplashScreen */], __WEBPACK_IMPORTED_MODULE_10__ionic_native_diagnostic__["a" /* Diagnostic */], __WEBPACK_IMPORTED_MODULE_11__ionic_native_location_accuracy__["a" /* LocationAccuracy */], __WEBPACK_IMPORTED_MODULE_13__ionic_native_network__["a" /* Network */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */], __WEBPACK_IMPORTED_MODULE_12__ionic_native_background_geolocation__["a" /* BackgroundGeolocation */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_14__ionic_native_native_geocoder__["a" /* NativeGeocoder */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */]])
    ], HomePage);
    return HomePage;
}());
...
var EntryPage = /** @class */ (function () {
    ...
    EntryPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_launch_navigator__["a" /* LaunchNavigator */]])
    ], EntryPage);
    return EntryPage;
}());
